...
var SvgSettings = (props) => /* @__PURE__ */ React32.createElement(
  ...
  /* @__PURE__ */ React32.createElement(
    ...
    /* @__PURE__ */ React32.createElement(Path24, { d: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6" }),
    /* @__PURE__ */ React32.createElement(Path24, { d: "M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 3.417 1.415 2 2 0 0 1-.587 1.415l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1" })
  ),
  /* @__PURE__ */ React32.createElement(Defs2, null, /* @__PURE__ */ React32.createElement(ClipPath2, { id: "settings_svg__a" }, /* @__PURE__ */ React32.createElement(Path24, { fill: "#fff", d: "M0 0h24v24H0z" })))
);
...
var SvgIconComponent = ({
  ...
  if (!Icon2) {
    ...
    return /* @__PURE__ */ React37.createElement(View, { style: [styles.placeholder, { width: sizeValue, height: sizeValue }, style] });
  }
  return /* @__PURE__ */ React37.createElement(
    ...
    /* @__PURE__ */ React37.createElement(Icon2, { width: sizeValue, height: sizeValue, color: colorValue, ...rest })
  );
};
...
var SvgImageComponent = ({
  ...
  if (!Image) {
    ...
    return /* @__PURE__ */ React39.createElement(View2, { style: [styles2.placeholder, style] });
  }
...
var Text2 = ({
  ...
  return /* @__PURE__ */ React40.createElement(RNText, { style: [styles3.text, style], numberOfLines }, children);
};
...
var Tag = ({
  ...
  return /* @__PURE__ */ React41.createElement(View3, { style: [containerStyle, style] }, iconName ? /* @__PURE__ */ React41.createElement(SvgIcon, { name: iconName, size: iconSize, color: props.color }) : null, props.children ? /* @__PURE__ */ React41.createElement(Text2, { ...props }) : null);
};
...
var Label = ({
  ...
  return /* @__PURE__ */ React42.createElement(View4, { style: [styles3.container, style] }, /* @__PURE__ */ React42.createElement(SvgIcon, { name: iconName, size: iconSize, color }), /* @__PURE__ */ React42.createElement(Text2, { fontSize, color, style: styles3.text, numberOfLines }, children));
};
...
var ConcurrencyTag = ({ available, total, labels }) => {
  ...
  return /* @__PURE__ */ React43.createElement(View5, { style: styles3.row }, /* @__PURE__ */ React43.createElement(View5, { style: dotStyle }), /* @__PURE__ */ React43.createElement(Text2, { fontSize: "font-size-sm", color }, label));
};
...
var AvailabilityTag = ({ status, labels }) => {
  ...
  return /* @__PURE__ */ React45.createElement(Tag, { color, surfaceColor, fontWeight: "semibold" }, label);
};
...
var Dot = ({ active }) => {
  ...
  return /* @__PURE__ */ React46.createElement(Animated.View, { style: [dotStyle, { backgroundColor }, animStyle] });
};
...
var StepIndicator = ({ total, current }) => {
  ...
  return /* @__PURE__ */ React47.createElement(View6, { style: styles3.row }, Array.from({ length: total }).map((_, i) => /* @__PURE__ */ React47.createElement(Dot, { key: i, active: i === current })));
};
...
var ActionModal = ({
  ...
  return /* @__PURE__ */ React48.createElement(Modal, { visible, transparent: true, animationType: "fade", onRequestClose: onCancel }, /* @__PURE__ */ React48.createElement(Pressable, { style: styles3.overlay, onPress: onCancel }, /* @__PURE__ */ React48.createElement(Pressable, { style: styles3.card, onPress: () => {
  } }, /* @__PURE__ */ React48.createElement(View7, { style: styles3.iconContainer }, /* @__PURE__ */ React48.createElement(
    SvgIcon,
    {
      name: icon,
      size: "icon-size-xl",
  ...
  )), /* @__PURE__ */ React48.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "extrabold", style: styles3.title }, title), /* @__PURE__ */ React48.createElement(Text2, { fontSize: "font-size-xs", color: "font-light", style: styles3.body }, body), /* @__PURE__ */ React48.createElement(View7, { style: styles3.actions }, /* @__PURE__ */ React48.createElement(TouchableOpacity, { style: styles3.confirmButton, onPress: onConfirm, activeOpacity: 0.8 }, /* @__PURE__ */ React48.createElement(Text2, { fontSize: "font-size-md", fontWeight: "bold", color: "font-invert" }, confirmLabel)), /* @__PURE__ */ React48.createElement(TouchableOpacity, { style: styles3.cancelButton, onPress: onCancel, activeOpacity: 0.7 }, /* @__PURE__ */ React48.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "semibold" }, cancelLabel))))));
};
...
// src/components/AppleSignInButton/AppleSignInButton.tsx
var AppleLogo = () => /* @__PURE__ */ React49.createElement(Svg30, { width: 17, height: 20, viewBox: "0 0 170 209" }, /* @__PURE__ */ React49.createElement(
  Path30,
  {
    fill: "#FFFFFF",
...
var AppleSignInButton = ({ label, onPress, disabled, submitting }) => {
  ...
  return /* @__PURE__ */ React49.createElement(TouchableOpacity2, { style: styles3.button, onPress, disabled: disabled || submitting, activeOpacity: 0.85 }, /* @__PURE__ */ React49.createElement(View8, { style: styles3.content }, /* @__PURE__ */ React49.createElement(AppleLogo, null), /* @__PURE__ */ React49.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "medium", color: "font-invert" }, label)));
};
...
// src/components/GoogleSignInButton/GoogleSignInButton.tsx
var GoogleLogo = () => /* @__PURE__ */ React50.createElement(Svg31, { width: 20, height: 20, viewBox: "0 0 48 48" }, /* @__PURE__ */ React50.createElement(Path31, { fill: "#FFC107", d: "M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z" }), /* @__PURE__ */ React50.createElement(Path31, { fill: "#FF3D00", d: "m6.306 14.691 6.571 4.819C14.655 15.108 18.961 12 24 12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 16.318 4 9.656 8.337 6.306 14.691z" }), /* @__PURE__ */ React50.createElement(Path31, { fill: "#4CAF50", d: "M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.91 11.91 0 0 1 24 36c-5.202 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z" }), /* @__PURE__ */ React50.createElement(Path31, { fill: "#1976D2", d: "M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002 6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917z" }));
var GoogleSignInButton = ({ label, onPress, disabled, submitting }) => {
  const { styles: styles3 } = useGoogleSignInButtonTheme();
  return /* @__PURE__ */ React50.createElement(TouchableOpacity3, { style: styles3.button, onPress, disabled: disabled || submitting, activeOpacity: 0.85 }, /* @__PURE__ */ React50.createElement(View9, { style: styles3.content }, /* @__PURE__ */ React50.createElement(GoogleLogo, null), /* @__PURE__ */ React50.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "medium", color: "font-primary" }, label)));
};
...
var SocialAuth = ({
  ...
  return /* @__PURE__ */ React51.createElement(View10, { style: styles3.container }, error && /* @__PURE__ */ React51.createElement(Text2, { fontSize: "font-size-xs", color: "font-error" }, error), /* @__PURE__ */ React51.createElement(View10, { style: styles3.dividerRow }, /* @__PURE__ */ React51.createElement(View10, { style: styles3.dividerLine }), /* @__PURE__ */ React51.createElement(Text2, { fontSize: "font-size-xs", color: "font-secondary" }, dividerLabel), /* @__PURE__ */ React51.createElement(View10, { style: styles3.dividerLine })), /* @__PURE__ */ React51.createElement(View10, { style: styles3.buttonsRow }, /* @__PURE__ */ React51.createElement(
    GoogleSignInButton,
    {
      label: googleLabel,
  ...
  ), showApple && /* @__PURE__ */ React51.createElement(
    AppleSignInButton,
    {
      label: appleLabel,
...
var AuthModeToggle = ({ promptLabel, linkLabel, onPress, disabled }) => {
  ...
  return /* @__PURE__ */ React52.createElement(
    ...
    /* @__PURE__ */ React52.createElement(Text2, { fontSize: "font-size-sm", color: "font-light" }, promptLabel),
    /* @__PURE__ */ React52.createElement(Text2, { fontSize: "font-size-sm", color: "font-highlight", fontWeight: "semibold" }, linkLabel)
  );
};
...
import React55, { useCallback } from "react";
...
var ActivityIndicator2 = ({ color = "font-primary", size = "small" }) => {
  const { resolvedColor } = useActivityIndicator({ color });
  return /* @__PURE__ */ React53.createElement(RNActivityIndicator, { color: resolvedColor, size });
};
...
var Button2 = ({
  ...
  return /* @__PURE__ */ React54.createElement(
    ...
    /* @__PURE__ */ React54.createElement(View11, { style: contentContainerStyle }, submitting ? /* @__PURE__ */ React54.createElement(ActivityIndicator2, { color: textColorMap[variant], size: "small" }) : /* @__PURE__ */ React54.createElement(View11, { style: contentStyle }, iconName ? /* @__PURE__ */ React54.createElement(SvgIcon, { name: iconName, size: iconSizeMap[size], color: textColorMap[variant] }) : null, label ? /* @__PURE__ */ React54.createElement(
      Text2,
      {
...
var ErrorScreen = ({ onReset, title, body, retryLabel }) => {
  ...
  return /* @__PURE__ */ React55.createElement(View12, { style: styles3.container }, /* @__PURE__ */ React55.createElement(View12, { style: styles3.content }, /* @__PURE__ */ React55.createElement(SvgIcon, { name: "AlertTriangle", size: "icon-size-xxxxxxl", color: "font-error" }), /* @__PURE__ */ React55.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "semibold", color: "font-primary" }, title), /* @__PURE__ */ React55.createElement(Text2, { fontSize: "font-size-sm", color: "font-secondary", textAlign: "center" }, body)), /* @__PURE__ */ React55.createElement(Button2, { label: retryLabel, onPress: handleRetry, variant: "primary", size: "md" }));
};

// src/components/ErrorBoundary/ErrorBoundary.tsx
var ErrorBoundary = class extends React56.Component {
  constructor() {
    super(...arguments);
...
var AuthRequiredScreen = ({
  ...
  return /* @__PURE__ */ React57.createElement(View13, { style: styles3.container }, /* @__PURE__ */ React57.createElement(View13, { style: styles3.contentContainer }, logo ?? null, /* @__PURE__ */ React57.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "semibold" }, title), /* @__PURE__ */ React57.createElement(Text2, { color: "font-light", fontSize: "font-size-sm" }, subtitle ?? defaultSubtitle)), /* @__PURE__ */ React57.createElement(Button2, { label: signInLabel, onPress: onSignIn }));
};
...
var Loader = ({ size = "icon-size-xxxxxxl" }) => {
  ...
  return /* @__PURE__ */ React58.createElement(View14, { style: styles3.container }, /* @__PURE__ */ React58.createElement(Animated2.View, { style: animatedStyle }, avatar && /* @__PURE__ */ React58.createElement(SvgImage, { name: avatar.imageName, height: iconSize, width: iconSize })));
};
...
var PillSelector = ({
  ...
  return /* @__PURE__ */ React60.createElement(View16, { style: styles3.outerContainer }, /* @__PURE__ */ React60.createElement(View16, { style: styles3.container, onLayout, ...props }, /* @__PURE__ */ React60.createElement(Animated4.View, { style: [styles3.thumb, thumbStyle, segmentWidthStyle] }), /* @__PURE__ */ React60.createElement(View16, { style: styles3.row }, options.map((o, i) => /* @__PURE__ */ React60.createElement(
    Pressable2,
    {
      key: o.value,
...
var SelectInput = ({
  ...
  return /* @__PURE__ */ React62.createElement(View17, { style: styles3.container }, label && /* @__PURE__ */ React62.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "semibold" }, label), /* @__PURE__ */ React62.createElement(Pressable4, { style: styles3.trigger, onPress: disabled ? void 0 : showModal }, /* @__PURE__ */ React62.createElement(
    Text2,
    {
      fontSize: "font-size-md",
  ...
  ), /* @__PURE__ */ React62.createElement(Animated5.View, { style: chevronStyle }, /* @__PURE__ */ React62.createElement(SvgIcon, { name: "ChevronRight", size: "icon-size-md", color: "font-secondary" }))), /* @__PURE__ */ React62.createElement(BottomSheet, { visible: modalVisible, onClose: hideModal, title: label }, /* @__PURE__ */ React62.createElement(View17, { style: styles3.optionsList }, options.map((option, idx) => /* @__PURE__ */ React62.createElement(
    SelectInputOption,
    {
      key: option.value,
      option,
  ...
  )))), error && /* @__PURE__ */ React62.createElement(View17, { style: styles3.footer }, /* @__PURE__ */ React62.createElement(Text2, { fontSize: "font-size-xs", color: "font-error" }, error)));
};
...
var ScreenHeader = ({
  ...
  return /* @__PURE__ */ React64.createElement(View18, { style: styles3.container }, !hideBack ? /* @__PURE__ */ React64.createElement(
    IconButton,
    {
  ...
  ) : null, /* @__PURE__ */ React64.createElement(View18, { style: styles3.titleGroup }, /* @__PURE__ */ React64.createElement(Text2, { fontSize: "font-size-xxl", fontWeight: "bold" }, title), subtitle ? /* @__PURE__ */ React64.createElement(Text2, { fontSize: "font-size-sm", color: "font-secondary" }, subtitle) : null));
};
...
var SafeScreenHeader = ({
  ...
  return /* @__PURE__ */ React65.createElement(View19, { style: styles3.wrapper }, /* @__PURE__ */ React65.createElement(
    ScreenHeader,
    {
      title,
      subtitle,
...
var SettingsMenu = ({ items }) => {
  ...
  return /* @__PURE__ */ React67.createElement(View20, { style: styles3.container }, items.map((item) => /* @__PURE__ */ React67.createElement(
    SettingsMenuItem,
    {
      key: item.label,
      label: item.label,
