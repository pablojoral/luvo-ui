...
var TextInput = ({
  ...
  )), /* @__PURE__ */ import_react11.default.createElement("div", { style: footerStyle }, error ? /* @__PURE__ */ import_react11.default.createElement("span", { style: errorStyle }, error) : null, remaining !== void 0 ? /* @__PURE__ */ import_react11.default.createElement("span", { style: remainingStyle }, remaining) : null));
};
...
var LoadErrorState = ({ message, title, retryLabel, onRetry, logo }) => {
  ...
  return /* @__PURE__ */ import_react39.default.createElement(import_react_native26.View, { style: styles3.container }, /* @__PURE__ */ import_react39.default.createElement(import_react_native26.View, { style: styles3.contentContainer }, logo ?? null, /* @__PURE__ */ import_react39.default.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "semibold", color: "font-primary" }, title), /* @__PURE__ */ import_react39.default.createElement(Text2, { fontSize: "font-size-sm", color: "font-secondary", textAlign: "center" }, message)), /* @__PURE__ */ import_react39.default.createElement(Button2, { label: retryLabel, variant: "primary", size: "md", onPress: onRetry }));
};
...
var AuthRequiredScreen = ({
  ...
  return /* @__PURE__ */ import_react40.default.createElement(import_react_native28.View, { style: styles3.container }, /* @__PURE__ */ import_react40.default.createElement(import_react_native28.View, { style: styles3.contentContainer }, logo ?? null, /* @__PURE__ */ import_react40.default.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "semibold" }, title), /* @__PURE__ */ import_react40.default.createElement(Text2, { color: "font-light", fontSize: "font-size-sm" }, subtitle ?? defaultSubtitle)), /* @__PURE__ */ import_react40.default.createElement(Button2, { label: signInLabel, onPress: onSignIn }));
};
...
var EXIT_MS = 180;
var useLoader = () => {
  const [index, setIndex] = (0, import_react41.useState)(0);
  ...
  const nextAvatar = (0, import_react41.useCallback)(() => {
...
var Loader = ({ size = "icon-size-xxxxxxl" }) => {
  ...
  return /* @__PURE__ */ import_react42.default.createElement(import_react_native30.View, { style: styles3.container }, /* @__PURE__ */ import_react42.default.createElement(import_react_native_reanimated4.default.View, { style: animatedStyle }, avatar && /* @__PURE__ */ import_react42.default.createElement(SvgImage, { name: avatar.imageName, height: iconSize, width: iconSize })));
};
...
var useBottomSheet = (visible) => {
  ...
  const [mounted, setMounted] = (0, import_react43.useState)(visible);
...
var BottomSheet = ({ visible, onClose, title, children }) => {
  ...
  return /* @__PURE__ */ import_react44.default.createElement(import_react_native33.Modal, { visible: mounted, transparent: true, animationType: "none", onRequestClose: onClose }, /* @__PURE__ */ import_react44.default.createElement(import_react_native33.View, { style: styles3.container }, /* @__PURE__ */ import_react44.default.createElement(import_react_native_reanimated6.default.View, { style: [styles3.backdrop, backdropStyle] }, /* @__PURE__ */ import_react44.default.createElement(import_react_native33.TouchableOpacity, { style: styles3.backdropPress, activeOpacity: 1, onPress: onClose })), /* @__PURE__ */ import_react44.default.createElement(import_react_native_reanimated6.default.View, { style: [styles3.sheet, sheetStyle] }, /* @__PURE__ */ import_react44.default.createElement(import_react_native33.View, { style: styles3.handle }), title && /* @__PURE__ */ import_react44.default.createElement(Text2, { fontSize: "font-size-md", fontWeight: "semibold", style: styles3.title }, title), children)));
};
...
var useAnimatedStyles = ({ options, value, onChange }) => {
  const [containerW, setContainerW] = (0, import_react45.useState)(0);
...
var PillSelector = ({
  ...
  return /* @__PURE__ */ import_react46.default.createElement(import_react_native35.View, { style: styles3.outerContainer }, /* @__PURE__ */ import_react46.default.createElement(import_react_native35.View, { style: styles3.container, onLayout, ...props }, /* @__PURE__ */ import_react46.default.createElement(import_react_native_reanimated8.default.View, { style: [styles3.thumb, thumbStyle, segmentWidthStyle] }), /* @__PURE__ */ import_react46.default.createElement(import_react_native35.View, { style: styles3.row }, options.map((o, i) => /* @__PURE__ */ import_react46.default.createElement(
    ...
    /* @__PURE__ */ import_react46.default.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "medium" }, o.label)
  )))));
};
...
var useSelectInputOptionTheme = (selected, isLast) => {
  ...
  const containerStyle = (0, import_react47.useMemo)(
...
var SelectInputOption = ({ option, selected, isLast, onPress }) => {
  ...
  return /* @__PURE__ */ import_react48.default.createElement(import_react_native37.Pressable, { style: containerStyle, onPress }, /* @__PURE__ */ import_react48.default.createElement(
    Text2,
    {
      fontSize: "font-size-sm",
    ...
    option.label
  ), selected && /* @__PURE__ */ import_react48.default.createElement(SvgIcon, { name: "Check", size: "icon-size-sm", color: "font-highlight" }));
};
...
var useSelectInput = ({ value, options, onChange }) => {
  const [modalVisible, setModalVisible] = (0, import_react49.useState)(false);
  const selectedLabel = options.find((o) => o.value === value)?.label;
  const showModal = (0, import_react49.useCallback)(() => setModalVisible(true), []);
  const hideModal = (0, import_react49.useCallback)(() => setModalVisible(false), []);
  const select = (0, import_react49.useCallback)(
    (val) => {
      onChange(val);
...
var SelectInput = ({
  ...
  return /* @__PURE__ */ import_react50.default.createElement(import_react_native39.View, { style: styles3.container }, label && /* @__PURE__ */ import_react50.default.createElement(Text2, { fontSize: "font-size-sm", fontWeight: "semibold" }, label), /* @__PURE__ */ import_react50.default.createElement(import_react_native39.Pressable, { style: styles3.trigger, onPress: disabled ? void 0 : showModal }, /* @__PURE__ */ import_react50.default.createElement(
    Text2,
    {
      fontSize: "font-size-md",
  ...
  ), /* @__PURE__ */ import_react50.default.createElement(import_react_native_reanimated10.default.View, { style: chevronStyle }, /* @__PURE__ */ import_react50.default.createElement(SvgIcon, { name: "ChevronRight", size: "icon-size-md", color: "font-secondary" }))), /* @__PURE__ */ import_react50.default.createElement(BottomSheet, { visible: modalVisible, onClose: hideModal, title: label }, /* @__PURE__ */ import_react50.default.createElement(import_react_native39.View, { style: styles3.optionsList }, options.map((option, idx) => /* @__PURE__ */ import_react50.default.createElement(
    SelectInputOption,
    {
      key: option.value,
      option,
  ...
  )))), error && /* @__PURE__ */ import_react50.default.createElement(import_react_native39.View, { style: styles3.footer }, /* @__PURE__ */ import_react50.default.createElement(Text2, { fontSize: "font-size-xs", color: "font-error" }, error)));
};
...
var useIconButtonTheme = ({ iconSize, surfaceColor }) => {
  const theme = useBaseTheme();
  const containerStyle = (0, import_react51.useMemo)(() => {
...
var IconButton = ({
  ...
  return /* @__PURE__ */ import_react52.default.createElement(import_react_native40.TouchableOpacity, { activeOpacity: 0.8, ...props, style: [containerStyle, style] }, /* @__PURE__ */ import_react52.default.createElement(SvgIcon, { name: iconName, size: iconSize, color: iconColor }));
};
...
var ScreenHeader = ({
  ...
  return /* @__PURE__ */ import_react53.default.createElement(import_react_native42.View, { style: styles3.container }, !hideBack ? /* @__PURE__ */ import_react53.default.createElement(
    IconButton,
    {
  ...
  ) : null, /* @__PURE__ */ import_react53.default.createElement(import_react_native42.View, { style: styles3.titleGroup }, /* @__PURE__ */ import_react53.default.createElement(Text2, { fontSize: "font-size-xxl", fontWeight: "bold" }, title), subtitle ? /* @__PURE__ */ import_react53.default.createElement(Text2, { fontSize: "font-size-sm", color: "font-secondary" }, subtitle) : null));
};
...
var SafeScreenHeader = ({
  ...
  return /* @__PURE__ */ import_react54.default.createElement(import_react_native44.View, { style: styles3.wrapper }, /* @__PURE__ */ import_react54.default.createElement(
    ScreenHeader,
    {
      title,
      subtitle,
...
var SettingsMenuItem = ({ label, iconName, onPress }) => {
  ...
  return /* @__PURE__ */ import_react55.default.createElement(import_react_native46.TouchableOpacity, { style: styles3.container, onPress, activeOpacity: 0.6 }, /* @__PURE__ */ import_react55.default.createElement(SvgIcon, { name: iconName, size: "icon-size-xxl", color: "font-primary" }), /* @__PURE__ */ import_react55.default.createElement(Text2, { fontSize: "font-size-lg", fontWeight: "medium", style: styles3.label }, label), /* @__PURE__ */ import_react55.default.createElement(SvgIcon, { name: "ChevronRight", size: "icon-size-lg", color: "font-primary" }));
};
...
var SettingsMenu = ({ items }) => {
  ...
  return /* @__PURE__ */ import_react56.default.createElement(import_react_native48.View, { style: styles3.container }, items.map((item) => /* @__PURE__ */ import_react56.default.createElement(
    SettingsMenuItem,
    {
      key: item.label,
      label: item.label,
...
var TagButton = ({
  ...
  return /* @__PURE__ */ import_react57.default.createElement(import_react_native49.TouchableOpacity, { onPress, disabled: disabled || loading }, /* @__PURE__ */ import_react57.default.createElement(
    Tag,
    {
      ...tagProps,
      disabled,
    ...
    loading ? /* @__PURE__ */ import_react57.default.createElement(ActivityIndicator2, { size: "small", color: tagProps.color }) : tagProps.children
  ));
};
