...
var Button = ({
  ...
  return /* @__PURE__ */ React5.createElement(
    ...
    /* @__PURE__ */ React5.createElement(View, { style: contentContainerStyle }, submitting ? /* @__PURE__ */ React5.createElement(ActivityIndicator, { color: textColorMap[variant], size: "small" }) : /* @__PURE__ */ React5.createElement(View, { style: contentStyle }, label ? /* @__PURE__ */ React5.createElement(
      Text,
      {
...
import { View as View3, TextInput as RNTextInput } from "react-native";
...
var TextInput = ({
  ...
  return /* @__PURE__ */ React7.createElement(View3, { style: styles3.container }, label ? /* @__PURE__ */ React7.createElement(Text, { fontSize: "font-size-sm", fontWeight: "semibold" }, label) : null, /* @__PURE__ */ React7.createElement(View3, { style: styles3.inputWrapper }, /* @__PURE__ */ React7.createElement(
    RNTextInput,
    {
      style: styles3.input,
  ...
  )), /* @__PURE__ */ React7.createElement(View3, { style: styles3.footer }, error ? /* @__PURE__ */ React7.createElement(Text, { fontSize: "font-size-xs", color: "font-error", style: styles3.errorText }, error) : null, remaining !== void 0 ? /* @__PURE__ */ React7.createElement(Text, { fontSize: "font-size-xs", color: "font-placeholder" }, remaining) : null));
};
...
var Switch = ({ value, onValueChange, disabled = false }) => {
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    /* @__PURE__ */ React8.createElement(Animated2.View, { style: [trackOverlayStyle, { opacity: trackOpacity }] }),
    /* @__PURE__ */ React8.createElement(Animated2.View, { style: [thumbStyle, { transform: [{ translateX }] }] })
  );
};

// src/components/SvgIcon/SvgIcon.tsx
import React36, { memo as memo2 } from "react";
import { View as View4, StyleSheet } from "react-native";
...
var SvgIconComponent = ({
  ...
  if (!Icon2) {
    ...
    return /* @__PURE__ */ React36.createElement(View4, { style: [styles.placeholder, { width: sizeValue, height: sizeValue }, style] });
  }
...
import { Modal, Pressable as Pressable2, TouchableOpacity as TouchableOpacity2, View as View10 } from "react-native";
...
import { TouchableOpacity as TouchableOpacity3, View as View11 } from "react-native";
...
import { TouchableOpacity as TouchableOpacity5 } from "react-native";
...
var LoadErrorState = ({ message, title, retryLabel, onRetry, logo }) => {
  ...
  return /* @__PURE__ */ React53.createElement(View15, { style: styles3.container }, /* @__PURE__ */ React53.createElement(View15, { style: styles3.contentContainer }, logo ?? null, /* @__PURE__ */ React53.createElement(Text, { fontSize: "font-size-lg", fontWeight: "semibold", color: "font-primary" }, title), /* @__PURE__ */ React53.createElement(Text, { fontSize: "font-size-sm", color: "font-secondary", textAlign: "center" }, message)), /* @__PURE__ */ React53.createElement(Button, { label: retryLabel, variant: "primary", size: "md", onPress: onRetry }));
};
...
var AuthRequiredScreen = ({
  ...
  return /* @__PURE__ */ React54.createElement(View16, { style: styles3.container }, /* @__PURE__ */ React54.createElement(View16, { style: styles3.contentContainer }, logo ?? null, /* @__PURE__ */ React54.createElement(Text, { fontSize: "font-size-lg", fontWeight: "semibold" }, title), /* @__PURE__ */ React54.createElement(Text, { color: "font-light", fontSize: "font-size-sm" }, subtitle ?? defaultSubtitle)), /* @__PURE__ */ React54.createElement(Button, { label: signInLabel, onPress: onSignIn }));
};
...
var Loader = ({ size = "icon-size-xxxxxxl" }) => {
  ...
  return /* @__PURE__ */ React55.createElement(View17, { style: styles3.container }, /* @__PURE__ */ React55.createElement(Animated4.View, { style: animatedStyle }, avatar && /* @__PURE__ */ React55.createElement(SvgImage, { name: avatar.imageName, height: iconSize, width: iconSize })));
};

// src/components/BottomSheet/BottomSheet.tsx
import React56 from "react";
import { Modal as Modal2, TouchableOpacity as TouchableOpacity6, View as View18 } from "react-native";
...
var PillSelector = ({
  ...
  return /* @__PURE__ */ React57.createElement(View19, { style: styles3.outerContainer }, /* @__PURE__ */ React57.createElement(View19, { style: styles3.container, onLayout, ...props }, /* @__PURE__ */ React57.createElement(Animated6.View, { style: [styles3.thumb, thumbStyle, segmentWidthStyle] }), /* @__PURE__ */ React57.createElement(View19, { style: styles3.row }, options.map((o, i) => /* @__PURE__ */ React57.createElement(
    Pressable3,
    {
      key: o.value,
...
var SelectInput = ({
  ...
  return /* @__PURE__ */ React59.createElement(View20, { style: styles3.container }, label && /* @__PURE__ */ React59.createElement(Text, { fontSize: "font-size-sm", fontWeight: "semibold" }, label), /* @__PURE__ */ React59.createElement(Pressable5, { style: styles3.trigger, onPress: disabled ? void 0 : showModal }, /* @__PURE__ */ React59.createElement(
    Text,
    {
      fontSize: "font-size-md",
  ...
  ), /* @__PURE__ */ React59.createElement(Animated7.View, { style: chevronStyle }, /* @__PURE__ */ React59.createElement(SvgIcon, { name: "ChevronRight", size: "icon-size-md", color: "font-secondary" }))), /* @__PURE__ */ React59.createElement(BottomSheet, { visible: modalVisible, onClose: hideModal, title: label }, /* @__PURE__ */ React59.createElement(View20, { style: styles3.optionsList }, options.map((option, idx) => /* @__PURE__ */ React59.createElement(
    SelectInputOption,
    {
      key: option.value,
      option,
  ...
  )))), error && /* @__PURE__ */ React59.createElement(View20, { style: styles3.footer }, /* @__PURE__ */ React59.createElement(Text, { fontSize: "font-size-xs", color: "font-error" }, error)));
};
...
var IconButton = ({
  ...
  return /* @__PURE__ */ React60.createElement(TouchableOpacity7, { activeOpacity: 0.8, ...props, style: [containerStyle, style] }, /* @__PURE__ */ React60.createElement(SvgIcon, { name: iconName, size: iconSize, color: iconColor }));
};
...
var ScreenHeader = ({
  ...
  return /* @__PURE__ */ React61.createElement(View21, { style: styles3.container }, !hideBack ? /* @__PURE__ */ React61.createElement(
    IconButton,
    {
  ...
  ) : null, /* @__PURE__ */ React61.createElement(View21, { style: styles3.titleGroup }, /* @__PURE__ */ React61.createElement(Text, { fontSize: "font-size-xxl", fontWeight: "bold" }, title), subtitle ? /* @__PURE__ */ React61.createElement(Text, { fontSize: "font-size-sm", color: "font-secondary" }, subtitle) : null));
};
...
var SafeScreenHeader = ({
  ...
  return /* @__PURE__ */ React62.createElement(View22, { style: styles3.wrapper }, /* @__PURE__ */ React62.createElement(
    ScreenHeader,
    {
      title,
      subtitle,
...
var SettingsMenuItem = ({ label, iconName, onPress }) => {
  ...
  return /* @__PURE__ */ React63.createElement(TouchableOpacity8, { style: styles3.container, onPress, activeOpacity: 0.6 }, /* @__PURE__ */ React63.createElement(SvgIcon, { name: iconName, size: "icon-size-xxl", color: "font-primary" }), /* @__PURE__ */ React63.createElement(Text, { fontSize: "font-size-lg", fontWeight: "medium", style: styles3.label }, label), /* @__PURE__ */ React63.createElement(SvgIcon, { name: "ChevronRight", size: "icon-size-lg", color: "font-primary" }));
};
...
var SettingsMenu = ({ items }) => {
  ...
  return /* @__PURE__ */ React64.createElement(View23, { style: styles3.container }, items.map((item) => /* @__PURE__ */ React64.createElement(
    SettingsMenuItem,
    {
      key: item.label,
      label: item.label,
...
var TagButton = ({
  ...
  return /* @__PURE__ */ React65.createElement(TouchableOpacity9, { onPress, disabled: disabled || loading }, /* @__PURE__ */ React65.createElement(
    Tag,
    {
      ...tagProps,
      disabled,
